...
from vision_agents.plugins import deepgram, elevenlabs, gemini, getstream, qwen
...
INSTRUCTIONS = f"Read @{Path(__file__).parent / 'instructions.md'}"
...
async def create_agent(**kwargs) -> Agent:
    ...
    agent = Agent(
        ...
        llm=qwen.Realtime(fps=1, base_url="wss://dashscope.aliyuncs.com/api-ws/v1/realtime"),
